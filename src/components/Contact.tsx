...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className="w-full bg-secondary/25 flex flex-col items-center gap-7 py-8 md:pt-13 md:px-6 lg:px-8"
    >
      <div className="max-w-4xl w-full">
        ...
        <div className="mt-12 text-center">
          <div className="bg-muted/50 rounded-lg p-6 md:p-8 max-w-2xl mx-auto">
